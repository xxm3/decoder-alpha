            ...
            {isNoBot ? (
                <>
                    <div className="server-module-bg p-4 px-6 w-full">
                        ...
                        <p>
                            Want to receive whitelists from new mints? Fill out
                            the below to help new mints see what you're about.
                        </p>
                        ...
                        <form
                            ...
                            onSubmit={handleSubmit(async (data) => {
                                ...
                                try {
                                    ...
                                    present({
                                        message:
                                            'Discord profile created successfully! New servers will now be able to see much more info. on your DAO',
                                        color: 'success',
                                        duration: 10000,
                                    });
                                    reset();
                ...
                <>
                    ...
                    <div className="server-module-bg p-4 px-6 w-full">
                        ...
                        <p>
                            Give your whitelist out to servers with 0 work on
                            your mods, 0 fake DAO screenshots, and soon 100%
                        ...
                        <div className="mt-3 mb-3 w-full flex ">
                            <IonButton
                                ...
                                `}
                                onClick={() =>
                                    history.push(`/seamless/${serverId}`)
                                }
                            >
                                Initiate Seamless
                            </IonButton>
                        ...
                        {authorizedModule === 0 ? (
                            <>
                                <span className="text-red-500">
                                    You don't have enough NFTs to add packages.
                                    Please purchase the appropriate amount and
                                    have your role verified in Discord. If you
                                    feel this is an error, then log out (bottom
                                    left) and log in again. If you want to give
                                    one of your admins (that have the NFTs) to
                                    manage the bots in your server, then click
                                    the 'Add Admin' button here{' '}
                                </span>
                            </>
                        ) : (
                            // else show how many packages they can add
                            <span className="text-green-500">
                                You are authorized to add {authorizedModule}{' '}
                                package(s)
                            </span>
                        )}
                    </div>
                        ...
                        <div className="server-module-bg p-4 px-6 w-full">
                            <div className="w-full flex items-center justify-between mb-3">
                                ...
                                <img
                                    ...
                                    src={
                                        showInstruction
                                            ? require(`../../images/up-icon.png`)
                                            : require(`../../images/chevron-down-icon.png`)
                                    }
                                    className="w-4 cursor-pointer"
                                    onClick={() =>
                                        setShowInstruction((e) => !e)
                                    }
                                />
                            </div>
                            ...
                            {showInstruction ? (
                                <div>
                                    ...
                                    <ul className="list-disc ml-5 leading-9">
                                        <li>
                                            Make a new private channel in your
                                            Discord. If doing the "Mints"
                                            package, name the channel
                                            "daily-mints" or whatever you want.
                                            Optionally make "1h-mint-info" if
                                            you want that as well. Or if you are
                                            doing the "Fox token" package, make
                                            a channel for the fox token names,
                                            and another channel for where users
                                            can enter their own bot commands
                                        </li>
                                        <li>
                                            Add the bot to the above channels
                                            (by going to the channel settings
                                            within Discord)
                                        </li>
                                        <li>Refresh this page</li>
                                        <li>
                                            Enable the "Mints" package (or "Fox
                                            token" package)
                                        </li>
                                        <li>
                                            It should ask you about the channels
                                            - pick your new channels. Click the
                                            test button. If it doesn't work,
                                            make sure the SOL Decoder bot is in
                                            that channel, and has permission to
                                            "Send Messages" (done within the
                                            channel settings in Discord)
                                        </li>
                                        <li>
                                            Wait for the channels to be
                                            populated with data before showing
                                            it to the public (8am EST is when
                                            daily-mints is populated, varying
                                            times for other channels)
                                        </li>
                                        <li>
                                            If doing the "Fox token" package,
                                            you need to first tell us before you
                                            can start using the bot commands
                                            (/token, /token_name,
                                            /wallet_tokens) in your server. You
                                            also need to add permission for any
                                            user in that channel to "Use
                                    ...
                                    <ul className="list-disc ml-5 leading-9">
                                        <li>
                                            Go to your new channel(s) in Discord
                                            - click "edit channel" in the
                                            sidebar
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            Permissions", make sure the bot is
                                        ...
                                        <li>- Attach Files</li>
                                        <li>
                                            Make sure the bot shows as "Online"
                                            in the sidebar
                                        </li>
                                        <li>
                                            Click the "Send a test message" and
                                            make sure it works
                                        </li>

                                        <img
                                            width="350px"
                                            src="https://cdn.discordapp.com/attachments/983706216733765642/984217168889667654/Screen_Shot_2022-06-08_at_6.07.31_PM.png"
                                        />
                                    </ul>
                                </div>
                            ) : (
                                        ...
                                        <div className="text-sm  mt-2 p-2 border-t-2">
                                            ...
                                            {mintMoreInfoShow ? (
                                                <ul className="list-disc ml-5 leading-7">
                                                    <li>
                                                        Your server can have the
                                                        "daily-mints" and
                                                        "1h-mint-info" feed, and
                                                        soon "tomorrows-mints".
                                                        Enable this to learn
                                                        more about each
                                                    </li>
                                                    <li>
                                                        Hold and you get
                                                        lifetime access, and get
                                                        free upgrades to
                                                        existing packages such
                                                        as getting daily
                                                        summaries of NFTs coming
                                                        out in a few weeks, when
                                                        they they get a bump in
                                                        their twitter / discord
                                                        numbers
                                                    </li>
                                                </ul>
                                            ) : (
                                    ...
                                    <div className="flex flex-col mt-4 p-2">
                                        ...
                                        <div className="text-sm mt-2 p-2 border-t-2">
                                            ...
                                            {foxTokenMoreInfoShow ? (
                                                <ul className="list-disc ml-5 leading-7">
                                                    <li>
                                                        Your server can have our
                                                        "analytics" feed (where
                                                        we show when tokens get
                                                        new names from the Fox
                                                        Token team), and users
                                                        can use our bot's slash
                                                        commands of /token_name
                                                        and /token and
                                                        /wallet_tokens{' '}
                                                    </li>
                                                    <li>
                                                        ...
                                                        free upgrades to
                                                        existing packages such
                                                        as getting alerts for
                                                        Fox Token price/listings
                                                        data (ie. alerted when
                                                        any fox token with a
                                                        name & greater than 1
                                                        sol price & greater than
                                                        10 listings is out){' '}
                                                    </li>
                                                    <li>
                                                        Please contact us after
                                                        enabling this, so we can
                                                        enable the bot commands
                                                        (/token, /token_name,
                                                        /wallet_tokens) in your
                                                        server
                                                    </li>
                                                </ul>
                                            ) : (
