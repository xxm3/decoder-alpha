                            ...
                            <ul className="list-disc ml-8 mt-3">
                                <li>
                                    ...
                                    <a
                                        ...
                                        href="https://discord.com/api/oauth2/authorize?client_id=927008889092857898&permissions=2048&redirect_uri=https%3A%2F%2Fsoldecoder.app%2Fmanageserver&response_type=code&scope=identify%20guilds%20guilds.members.read%20bot"
                                    >
                                        click here
                                    </a>{' '}
                                ...
                                <li>
                                    {' '}
                                    Or if using the "Fox Token" bots (where
                                    users can type /token),{' '}
                                    <a
                                        className="underline cursor-pointer"
                                ...
                                <li>
                                    If you are a new mint and are using the
                                    Whitelist bots (where we will give users
                ...
                <div className="py-3">
                    ...
                    <ul className="list-disc ml-8 leading-9">
                        ...
                        <li>
                            ...
                            4 NFTs to unlock a second bot package, and get most
                            future bot packages for free
                        </li>
                        <li>
                    ...
                    <ul className="list-disc ml-8 leading-9">
                        <li>
                            <b>Bot package #1 - Mints package</b> - Your server
                            can have our "daily-mints" feed and "1h-mint-info"
                            and soon "tomorrows-mints"
                        </li>
                        <li>
                            <b>Bot package #2 - Fox token package</b> - Your
                            server can have our "Fox Token" feed, and users can
                            use our bot's slash commands of /token_name and
                            /token (which shows Fox Token Market info from a
                            token address or name) and /wallet_tokens (Get Fox
                            Token Market info for all tokens in an address)
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc ml-8 leading-9">
                        <li>
                            <b>"Magic Eden" package:</b> (1) use the command
                            "/me_floor bohemia" and you'll get the price info of
                            Bohemia, (2) get alerted whenever a sale for your
                            NFT occurs, and (3) use the command "/tps" to see a
                            live count of Solana's Transactions Per Second
