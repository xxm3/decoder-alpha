          ...
          <div className='left-content-wrapper px-3 mb-8'>
            ...
            <div className='text-wrapper xl:p-2 sm:px-8 px-3 '>
              <div className='py-3'>
                ...
                <p className='text-sm'>
                  This statue is a 1/1 NFT made by Pompeizz to show some love to the most inspiring project of the Solana blockchain, DeGods.
                </p>
              </div>
          ...
          <div className='right-content-wrapper  px-3'>
            <div className='flex w-full justify-between items-center p-2'>
              ...
              <div className='flex gap-3 mr-auto ml-5'>
                <img src="./assets/icons/discord.png" className="w-5 h-4" alt=""/>
                <img src="./assets/icons/discord.png" className="w-5 h-4" alt=""/>
                <img src="./assets/icons/discord.png" className="w-5 h-4" alt=""/>
              </div>

              <a href="#" className='text-xl underline underline-offset-4'>View tokens</a>
            </div>

            <div className='flex gap-2 text-center my-3'>
              <div className='basis-1/4 p-3 py-4 c-block-bg rounded-md'>
                Project
                <br />
                Pompeizz 1/1
              </div>
            ...
            <div className='p-3 py-7 c-block-bg text-center rounded-md my-4'>
              <div className='text-lg'>Auction closed!</div>
              <div className='text-lg'>Congrats to the winner</div>
            ...
            <div className='p-7 c-block-bg rounded-md my-4'>
              ...
              <div>
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 pt-5 relative'>
                  <div className='flex col-span-2 sm:col-span-1'>TG41....UwQr</div>
