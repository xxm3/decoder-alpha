        ...
        <>
            <div className="border-gray-500 border-[0.5px] rounded-2xl w-80 overflow-clip">
                ...
                <div className="relative overflow-y-hidden h-60 w-80">
                    <img src={image} className="h-full w-full object-cover object-left" alt={`${sourceServer?.name}`} />
                    <div className="absolute flex bottom-0 right-0 justify-between bg-white bg-opacity-50 dark:bg-black dark:bg-opacity-50 py-2 px-5 left-0">
                        <div className="w-full">
                            <p className="font-bold text-lg">{sourceServer?.name} || {targetServer?.name}</p>
                            <p className="text-sm italic">  Whitelist  </p>
                        </div>
                        ...
                        {twitter && (
                            <a  href={twitter} className="self-center hover:opacity-70" target="_blank" >
